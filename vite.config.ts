...
import { firmosPwaPlugin } from "./scripts/firmos-pwa-plugin.mjs";
// @ts-expect-error JS plugin alongside the TS vite config
...
export default defineConfig(({ command, isPreview }) => ({
  ...
  plugins: [
    ...
    authPopupPlugin(),
    appEnvPlugin(),
    // FirmOS owns the PWA integration boundary. The legacy implementation is
    // currently delegated behind scripts/firmos-pwa-plugin.mjs and will be
    // replaced incrementally in the next migration step.
    firmosPwaPlugin(),
    tailwindcss(),
    tanstackStart(),
